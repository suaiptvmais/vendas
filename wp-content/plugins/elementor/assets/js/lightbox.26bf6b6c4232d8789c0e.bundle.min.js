        ...
        3896: (e, t, n) => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                getShareLinks() {
                    ...
                    }, n = jQuery, i = this.getSettings("classes"), o = this.getSettings("selectors"), l = n("<div>", {
                        class: i.slideshow.shareLinks
                    }), a = this.getSlide("active"), r = a.find(o.image), d = a.data("elementor-slideshow-video");
                    let c;
                    if (c = d || r.attr("src"), n.each(t, ((e, t) => {
                            const i = t.label,
                                s = n("<a>", {
                        ...
                        t.attr("aria-label", e.download), l.append(n("<a>", {
                            href: c,
                            download: ""
                ...
                getSlideshowHeader() {
                    ...
                    if (n || i || o || l) {
                        ...
                        if (o) {
                            ...
                            this.isFontIconSvgExperiment || (l.class = r.iconZoomIn), d.$iconZoom = t(n).attr(l).on("click", this.toggleZoomMode), i.push(d.$iconZoom), this.isFontIconSvgExperiment && (d.$iconZoomOut = t(s.zoomOutBold.element).attr(o).addClass(a.hidden).on("click", this.toggleZoomMode), i.push(d.$iconZoomOut)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                        if (i) {
                            ...
                            this.isFontIconSvgExperiment || (l.class = r.iconExpand), d.$iconExpand = t(n).append(t("<span>"), t("<span>")).attr(l).on("click", this.toggleFullscreen), i.push(d.$iconExpand), this.isFontIconSvgExperiment && (d.$iconMinimize = t(s.frameMinimize.element).attr(o).addClass(a.hidden).on("click", this.toggleFullscreen), i.push(d.$iconMinimize)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                ...
                setSlideshowContent(e) {
                    const {
                        i18n: t
                    } = elementorFrontend.config, n = jQuery, i = 1 === e.slides.length, o = "" !== elementorFrontend.getKitSettings("lightbox_title_src"), l = "" !== elementorFrontend.getKitSettings("lightbox_description_src"), a = o || l, r = this.getSettings("classes"), d = r.slideshow, c = n("<div>", {
                        class: d.container
                    }), h = n("<div>", {
                    ...
                    if (e.slides.forEach((e => {
                            ...
                            if (e.video) {
                                ...
                                const i = this.isFontIconSvgExperiment ? s.loading.element : "<i>",
                                    l = n("<div>", {
                                        class: r.playButton
                                    }).html(n(i).attr("aria-label", t.playVideo).addClass(r.playButtonIcon));
                                o.append(l)
                            } else {
                                const t = n("<div>", {
                        ...
                        }).append(i, l), c.append(g, m), this.$buttons = this.$buttons.add(g).add(m)
                    }
                    ...
                    p.onShow = async () => {
                        ...
                        this.swiper = await new s(c, t), c.data("swiper", this.swiper), this.playSlideVideo(), a && this.updateFooterText(), this.bindHotKeys(), this.makeButtonsAccessible()
                    }
                },
                ...
                prepareYTVideo(e, t, n, i, s) {
                    ...
                    i.append(l), window.chrome && (a = e.PlayerState.UNSTARTED), n.addClass("elementor-loading " + o.invisible), this.player = new e.Player(l[0], {
                        videoId: t,
                        events: {
                            onReady: () => {
                            ...
                            onStateChange: e => {
                                e.data === a && n.removeClass("elementor-loading " + o.invisible)
                            }
                        },
                        playerVars: {
                            controls: 0,
